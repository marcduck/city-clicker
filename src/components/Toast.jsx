...
function Toast({setShowToast, showToast, toastMessage}) {
  ...
  return (
    <div ref={toastRef} id="toast-success" className=" flex items-center w-full max-w-xs p-4 mb-4 text-slate-500 bg-white rounded-lg shadow dark:text-slate-400 dark:bg-slate-800 fixed bottom-0 left-5 invisible" role="alert">
