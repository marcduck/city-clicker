...
export function initializeObjectFromStorage(item, initialValue) {
  return useState(() => {
...
export function getPropertyIncome(price, percentage = 0.003) {
  return roundTo(price * percentage);
}

export function clearLocalStorage() {
  var proceed = confirm("Are you REALLY sure you want to reset your save?");
  if (proceed) {
    //proceed
    localStorage.clear();
...
export function shortNum(n = 0, decimals = 1, min = 1_000_000) {
  if (n > min) {
